...
# from https://raw.githubusercontent.com/MarcSkovMadsen/awesome-streamlit/master/gallery
# /bokeh_experiments/bokeh_experiments.py
...
def main():
    ...
    [Bokeh](https://docs.bokeh.org/en/latest/) is an interactive visualization library for modern 
    web
    browsers. Bokeh has an extensive
    [quickstart guide](https://docs.bokeh.org/en/latest/docs/user_guide/quickstart.html), a large
    [gallery of examples](https://docs.bokeh.org/en/latest/docs/gallery.html#gallery) and an 
    extensive
    ...
    [`st.bokeh_chart`](https://streamlit.io/docs/api.html?highlight=bokeh_chart#streamlit
    .bokeh_chart)
...
def widgets_tables_panel():
    ...
    text = """
<br>With Bokeh you can do advanced
[bokeh.models.widgets.tables](https://docs.bokeh.org/en/latest/docs/reference/models/widgets
.tables.html).

Below a simple `bokeh.models.widgets.DataTable` is shown. I believe you can do very advanced 
things with
...
- Enabling **Python Callbacks** for advanced interactivity. I have a gut feeling it's easy to 
integrate because
...
[`bokeh.models.callbacks`](https://docs.bokeh.org/en/latest/docs/reference/models/callbacks.html
?highlight=customjs#bokeh.models.callbacks.CustomJS)
in JavaScript.
...
- [Bokeh Server - Developer Guide](https://docs.bokeh.org/en/latest/docs/dev_guide/server.html
#devguide-server)
- [Flask embedding example](https://github.com/bokeh/bokeh/blob/1.1.0/examples/howto/server_embed
/flask_embed.py)

If we could get the integration working we would have access the full set of **Bokeh interactive 
widgets**
as found in the [Bokeh User Guide](https://docs.bokeh.org/en/latest/docs/user_guide/interaction
/widgets.html) and shown below
...
"""
    ...
    dropdown = bokeh.models.widgets.Dropdown(
        label="Dropdown button", button_type="warning", menu=menu
    )
    text_input = bokeh.models.widgets.TextInput(value="default", title="Text Input:")
    color_picker = bokeh.models.widgets.ColorPicker(
        color="#ff4466", title="Choose color:", width=200
    )
    file_input = bokeh.models.widgets.FileInput()
    multi_select = bokeh.models.widgets.MultiSelect(
        title="Option:",
        value=["foo", "quux"],
    ...
    select = bokeh.models.widgets.Select(
        title="Option:", value="foo", options=["foo", "bar", "baz", "quux"]
    )
    slider = bokeh.models.widgets.Slider(
        start=0, end=10, value=1, step=0.1, title="Stuff"
    )
    range_slider = bokeh.models.widgets.RangeSlider(
        start=0, end=10, value=(1, 9), step=0.1, title="Stuff"
    )
    text_input = bokeh.models.widgets.TextAreaInput(
        value="default", rows=6, title="Label:"
    )
    toggle = bokeh.models.widgets.Toggle(label="Foo", button_type="success")
    div = bokeh.models.widgets.Div(
        text="""Your <a 
    href="https://en.wikipedia.org/wiki/HTML">HTML</a>-supported text is initialized with the 
    <b>text</b> argument.  The
remaining div arguments are <b>width</b> and <b>height</b>. For this example, those values
are <i>200</i> and <i>100</i> respectively.""",
        width=200,
        height=100,
    )
    paragraph = bokeh.models.widgets.Paragraph(
        text="""Your text is initialized with the 'text' 
    argument.  The
    ...
    pretext = bokeh.models.widgets.PreText(
        text="""Your text is initialized with the 'text' 
    argument.
